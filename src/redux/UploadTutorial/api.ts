...
export const setstatus= (stat: status): AppThunk => (dispatch) => {
  ...
  export const UploadTutorial = (file:any, data: any): AppThunk => async (dispatch) => {
    ...
    try{
        ...
        console.log(file);
        const icon= data ? "Productions/Video/Tutorial.mp4" : "Development/Video/Tutorial.mp4"
