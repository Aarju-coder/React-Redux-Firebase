...
export default function TutorialPage() {
  ...
  const [fileName, setfileName] = useState("Upload Tutorial");
  const { loading, success, error } = useSelector<RootState, RootState["tutorialUploadSatatus"]>(status);
  ...
  function onSubmitHandler(e: any) {
    ...
    if (file) {
      ...
      dispatch(UploadTutorial(file, isdevOrProd))
    }
          ...
          <div className="row">
            <div className="col-md-12">
              <form className="mb-5" onSubmit={onSubmitHandler}>
                ...
                {success && <p style={{color: "green"}}>Tutorial Updated.</p>}
